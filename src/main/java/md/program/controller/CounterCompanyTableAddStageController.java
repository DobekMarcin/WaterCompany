...
import md.program.modelFX.CounterCompanyYearModel;
...
public class CounterCompanyTableAddStageController {
    ...
    private CounterCompanyYearModel counterYearModel = new CounterCompanyYearModel();
