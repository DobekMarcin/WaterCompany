...
public class PaymentPlanModel {
    ...
    public void generatePaymentPlan(Integer generateYear) throws SQLException, RuntimeException {
        ...
        partnerList.forEach(item -> {
            PaymentPlan temp = getPaymentPlan(generateYear, item, finalRateYear);
    ...
    public void generatePaymentPlanOnePerson(Integer generateYear, PaymentPlanFX paymentPlanFX) throws SQLException, RuntimeException {
        ...
        RateYear finalRateYear = rateYear;
        paymentPlan = getPaymentPlan(generateYear, partner, finalRateYear);
        paymentPlan.setId(paymentPlanId);
        paymentPlanRepository.updatePaymentPlan(paymentPlan);
    }

    private static PaymentPlan getPaymentPlan(Integer generateYear, Partner item, RateYear finalRateYear) {
